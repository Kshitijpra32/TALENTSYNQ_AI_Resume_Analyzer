    ...
    def render_about(self):
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About TALENTSYNQ</h1>
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "TALENTSYNQ represents my vision of democratizing career advancement through technology. 
    ...
    def render_feedback_page(self):
        ...
        st.markdown("""
            <div class="feedback-header">
                ...
                <p>Help us improve TALENTSYNQ with your valuable feedback</p>
            </div>
        """, unsafe_allow_html=True)
